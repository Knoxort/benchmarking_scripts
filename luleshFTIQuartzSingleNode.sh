...
#gsList="4 32"
#nsList="2"
#gsList="8 27" 	#Group Size List (Total Number of Nodes?); max size is 32
#nsList="1" 		#Node Size List (Ranks per Node)
gsList="2" 	#Group Size List (Total Number of Nodes?); max size is 32
nsList="4 32" 		#Node Size List (Ranks per Node)
#gsList="3" 	#Group Size List (Total Number of Nodes?); max size is 32
#nsList="9" 		#Node Size List (Ranks per Node)
eprList="25 50 75 100 125 150 175 200 225 250";	#Elements per Rank List	
