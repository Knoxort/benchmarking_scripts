  ...
  if(fileName.endswith(fullInputExtension)):
    ...
    with open(fileName) as inputFile:
      ...
      for dataRow in data:
        ...
        statLine=kernelName+','+currRow[0]+','+currRow[1]+','+currRow[2]+','+currRow[3]+','+str(dataCount)+','+str(+errorCount)+','+'\n'
        ...
        outputLine=currRow[0]+','+currRow[1]+','+currRow[2]+','+currRow[3]+','+str(average)+'\n'  #Need to find a way to loop over the parameters, instead of hard coding printing them thre times
