...
qCpN="30"	#Quartz cores per node
#numCoresList="1 8 27 64 125 216 343 512 1000 1728 2197 4913 32768";
numCoresList="1 8" # 27 64 125";
#probSizeList="5";	
probSizeList="5 10 45"; # 50 75 90";	
chkptFreqList="1 10";			#When I start doing different checkpointing frequencies, I need to find a way that this only runs when prem is activated.
