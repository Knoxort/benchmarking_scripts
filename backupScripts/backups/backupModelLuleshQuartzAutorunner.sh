...
#probSizeList="5";	
probSizeList="10";	
chkptFreqList="100";			#When I start doing different checkpointing frequencies, I need to find a way that this only runs when prem is activated.
...
do
	...
	do
		...
		echo "#SBATCH -p pbatch" >> $outputJobFile                  #For TST18, only 1 node/16 cores for quartz
	        echo "#SBATCH -t 00:30:00" >> $outputJobFile
