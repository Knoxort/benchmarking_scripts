...
#gsList="8 27 64" 	#Group Size List (Total Number of Nodes?); max size is 32
...
eprList="1 2 4 8 16 32 64 128 256";	#Elements per Rank List	
...
do
	...
	do
		...
		echo "#SBATCH -p pbatch" >> $outputJobFile                  #For TST18, only 1 node/16 cores for quartz
	        echo "#SBATCH -t 00:05:00" >> $outputJobFile
